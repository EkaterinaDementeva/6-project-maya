...
class MyDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # Initializing all properties and settings of the QDialog class
        ...
        # you cannot make the window smaller
        ...
        # Call fuction - binding the slider's valueChanged signal to
        # the LineEdit
        ...
        icon = QtGui.QIcon(
            "C:/Users/Admin/Documents/Maya/Уроки/6 неделя июль/apply.png"
            )  # Icon file path
    ...
    def move_coordinate_x(self, coordinate_x):
        """Binding the slider's valueChanged signal
        to the update_line_edit method"""

        self.slider_x.valueChanged[int].connect(
            self.value_x.setText(str(coordinate_x))
            )
